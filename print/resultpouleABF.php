...
$sql="SELECT * FROM poule INNER JOIN katatype ON poule.katatype=katatype.idKatatype WHERE katatype = :katatype AND tournament = :tournament";
$result = $db->prepare($sql);
$result->bindValue(':katatype', $_GET["katatype"]);
